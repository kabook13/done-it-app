<?php
 /* Template: posts-single One */
/**
 * 
 * Template for the profile single Crossword posts
 *
...
// Ensure this template is only used for posts of type 'Crossword'
if ( 'crossword' !== get_post_type( $post ) && 'user_crossword' !== get_post_type( $post ) ) {
	return;
}
?>
